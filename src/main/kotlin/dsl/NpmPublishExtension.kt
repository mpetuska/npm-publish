...
open class NpmPublishExtension(private val project: Project) : NpmPublishExtensionScope {
   ...
   */
  var access: NpmAccess by project.propertyDelegate(default = NpmAccess.PUBLIC) {
   ...
   */
  var bundleKotlinDependencies: Boolean by project.propertyDelegate(default = true) {
    it.notFalse()
  }
   ...
   */
  var shrinkwrapBundledDependencies: Boolean by project.propertyDelegate(default = true) {
    it.notFalse()
  }
  ...
  /**
   * DSL exposing [NpmPublication] creation and configuration. Will look for existing publication
