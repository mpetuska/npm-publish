 ...
 */
abstract class PackageJson : JsonObject<Any>() {
  ...
  @get:Nested
  @get:Optional
  abstract val config: Property<JsonObject<Any>>
  ...
  @get:Nested
  @get:Optional
  abstract val dependencies: Property<JsonObject<String>>

  /** [devDependencies](https://docs.npmjs.com/files/package.json#devdependencies) */
  @get:Nested
  @get:Optional
  abstract val devDependencies: Property<JsonObject<String>>

  /** [peerDependencies](https://docs.npmjs.com/files/package.json#peerdependencies) */
  @get:Nested
  @get:Optional
  abstract val peerDependencies: Property<JsonObject<String>>

  /** [optionalDependencies](https://docs.npmjs.com/files/package.json#optionaldependencies) */
  @get:Nested
  @get:Optional
  abstract val optionalDependencies: Property<JsonObject<String>>
