 ...
 */
abstract class NpmExecTask @Inject constructor(nodeJsDir: File?) : DefaultTask() {
  ...
  fun nodeExec(args: Collection<Any?>, config: ExecSpec.() -> Unit = {}) =
      project.exec {
  ...
  fun npmExec(args: Collection<Any?>, config: ExecSpec.() -> Unit = {}) =
